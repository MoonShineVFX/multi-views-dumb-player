...
function ThemeButton(props) {
    ...
    return (0, jsx_runtime_1.jsx)(Button, __assign({ onPointerEnter: function () { return setIsHover(true); }, onPointerLeave: function () { return setIsHover(false); }, style: { fill: isHover ? (colors === null || colors === void 0 ? void 0 : colors.highlight) || 'aquamarine' : (colors === null || colors === void 0 ? void 0 : colors.main) || 'white' } }, passProps));
}
// PlayButton
function PlayButton(props) {
    var CurrentButton = props.isPlaying ? icons_1.IconPause : icons_1.IconPlay;
    return (0, jsx_runtime_1.jsx)(ThemeButton, { Button: CurrentButton, colors: props.colors, className: PlaybackControl_module_css_1.default.buttonIcon, onClick: props.onClick });
}
// TimeStampText
