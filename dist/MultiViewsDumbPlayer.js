    ...
    (0, react_1.useEffect)(function () {
        if (isMSE && videoRef.current && !msePlayer) {
            ...
            setMsePlayer(new multi_vision_player_1.default(videoRef.current, props.url, {
                streamHost: "".concat(window.location.protocol, "//").concat(window.location.host)
...
function Layer(props) {
    ...
    return (0, jsx_runtime_1.jsx)("div", __assign({ className: className, style: props.style }, { children: props.children }), void 0);
}
